...
* **`Only include subjects with non-zero denominator in local ratio [Experimental]`**
    ...
    * [ ] = Average for each location will include all subjects. Subjects with no streamlines terminating in that region, parcel, or pair will be assigned a ChaCo=0 in that location.
