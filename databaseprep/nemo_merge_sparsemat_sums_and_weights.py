...
fileroot=sys.argv[2]
endpointfile=sys.argv[3]
endpointmaskfile=sys.argv[4]
outfile_weights=sys.argv[5]
outfile_length=sys.argv[6]
outfile_asum=sys.argv[7]
outfile_asum_endpoints=sys.argv[8]
outfile_asum_weighted=sys.argv[9]
outfile_asum_weighted_endpoints=sys.argv[10]
